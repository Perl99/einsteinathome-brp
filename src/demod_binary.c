...
int MAIN (int argc, char *argv[])
{
  ...
  logMessage(info, true, "Starting data processing...\n");
    ...
    logMessage(info, true, "Changes: 1. sanity check in sincosLUTLookup disabled in release mode, moved to resamp_cpu\n");
    logMessage(info, true, "2. remove calculating cosX because it is not used\n");
    logMessage(info, true, "3. use SSE up to SSE4 in the whole project\n");
    ...
    logMessage(info, true, "7. FFTW 3.3.3 using AVX\n");
